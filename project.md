...
- batch_size=32，训练了200个epoch，大约在180个epoch左右就达到了最优效果，[mAP_0.5](https://blog.csdn.net/luke_sanjayzzzhong/article/details/89851944) = 41.3%
...
- 调整超参数文件，增大饱和度、明度、旋转角度、水平和垂直平移 、剪切、上下翻转 和进行[mixup](https://www.zhihu.com/question/308572298?sort=created)的概率，减少回归框的损失的权重;
...
- [分割领域常用评价指标](https://zhuanlan.zhihu.com/p/117435908)
- [loss不收敛或不下降问题处理经验](http://t.zoukankan.com/yifanrensheng-p-14087871.html)